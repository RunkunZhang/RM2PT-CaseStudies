...
public class ThirdPartyServicesController {
	...
	public String generateURL() {
		...
		try {
			object.put("data", thirdPartyServices.generateURL());
	...
	public String download(DownloadMessage downloadMsg) {
		
		
		JSONObject object = new JSONObject();
		try {
			object.put("data", thirdPartyServices.download(downloadMsg.url));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
